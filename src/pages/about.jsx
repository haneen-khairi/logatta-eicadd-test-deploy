  ...
  return (
    <>
        ...
        <Grid container spacing={3} alignItems="center">
            ...
            <Grid item xs={12} sm={6}>
                <Stack >
                    <Typography variant="h3" color="#621493" mb="1rem">اول مراكز تدخل مبكر مدعومة بالذكاء الاصطناعي لتقييم وعلاج التوحد والاضطرابات التطورية في الشرق الأوسط - الرعاية الرائدة في منطقة الشرق الأوسط وشمال أفريقيا للأطفال</Typography>
